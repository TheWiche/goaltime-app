  ...
  return (
    <div className="flex flex-col gap-3 border-b border-slate-100 py-3 sm:flex-row sm:items-center sm:justify-between sm:pl-2 sm:pr-1">
      <div className="flex flex-wrap items-center gap-2">
        <label htmlFor="associate-fields-page-size" className="sr-only">
          Entradas por página
        </label>
        <select
          id="associate-fields-page-size"
              ...
              {filterOptions.map((opt) => (
                <button
                  ...
                  className={[
                    ...
                    statusFilter === opt.value ? "bg-primary-50 font-semibold text-primary-900" : "",
                  ].join(" ")}
                  onClick={() => {
